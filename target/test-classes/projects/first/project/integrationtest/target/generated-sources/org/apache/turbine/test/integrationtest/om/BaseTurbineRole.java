...
{
    /** Serial version */
    private static final long serialVersionUID = 1538675156496L;
    ...
    public List<TurbineRolePermission> getTurbineRolePermissions(Criteria criteria) throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(org.apache.turbine.test.integrationtest.om.TurbineRolePermissionPeer.ROLE_ID, getEntityId() );
                collTurbineRolePermissions = org.apache.turbine.test.integrationtest.om.TurbineRolePermissionPeer.doSelect(criteria);
            }
        }
        else
        {
            ...
            throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(org.apache.turbine.test.integrationtest.om.TurbineRolePermissionPeer.ROLE_ID, getEntityId());
                collTurbineRolePermissions = org.apache.turbine.test.integrationtest.om.TurbineRolePermissionPeer.doSelect(criteria, con);
            }
        }
        else
        {
            ...
            if (!isNew())
            {
                ...
                // one, just return the collection.
                criteria.and(org.apache.turbine.test.integrationtest.om.TurbineRolePermissionPeer.ROLE_ID, getEntityId());
                if (!lastTurbineRolePermissionCriteria.equals(criteria))
                {
                    collTurbineRolePermissions = org.apache.turbine.test.integrationtest.om.TurbineRolePermissionPeer.doSelect(criteria, con);
                }
            }
    ...
    {
        return getTurbineRolePermissionsJoinTurbineRole(criteria, null);
    }
        ...
        throws TorqueException
    {
        if (collTurbineRolePermissions == null)
        {
            ...
            {
                criteria.and(org.apache.turbine.test.integrationtest.om.TurbineRolePermissionPeer.ROLE_ID, getEntityId() );
                collTurbineRolePermissions = org.apache.turbine.test.integrationtest.om.TurbineRolePermissionPeer.doSelectJoinTurbineRole(criteria, connection);
            }
        }
        else
        {
    ...
    public List<TurbineUserGroupRole> getTurbineUserGroupRoles(Criteria criteria) throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(org.apache.turbine.test.integrationtest.om.TurbineUserGroupRolePeer.ROLE_ID, getEntityId() );
    ...
    {
        return getTurbineUserGroupRolesJoinTurbineRole(criteria, null);
    }
        ...
        throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(org.apache.turbine.test.integrationtest.om.TurbineUserGroupRolePeer.ROLE_ID, getEntityId() );
                collTurbineUserGroupRoles = org.apache.turbine.test.integrationtest.om.TurbineUserGroupRolePeer.doSelectJoinTurbineRole(criteria, connection);
            }
        }
        else
        {
    ...
    {
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineRolePeer.ROLE_ID))
        {
            return getEntityId();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineRolePeer.ROLE_NAME))
        {
            return getEntityName();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
        if (org.apache.turbine.test.integrationtest.om.TurbineRolePeer.ROLE_ID.getSqlExpression().equals(name))
        {
            return setByName("EntityId", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineRolePeer.ROLE_NAME.getSqlExpression().equals(name))
        {
    ...
    protected TurbineRole copyInto(TurbineRole copyObj, boolean deepcopy) throws TorqueException
    {
        ...
        if (deepcopy)
        {
            if (collTurbineRolePermissions != null)
            {
                for (int i = 0; i < collTurbineRolePermissions.size(); i++)
                {
                    TurbineRolePermission obj = collTurbineRolePermissions.get(i);
    ...
    /** The Peer class */
    private static final org.apache.turbine.test.integrationtest.om.TurbineRolePeer peer
            = new org.apache.turbine.test.integrationtest.om.TurbineRolePeer();
     ...
     */
    public org.apache.turbine.test.integrationtest.om.TurbineRolePeer getPeer()
    {
        return peer;
    }
    ...
    {
        return org.apache.turbine.test.integrationtest.om.TurbineRolePeer.getTableMap();
    }
