...
public abstract class BaseTurbineUserPeerImpl
    extends org.apache.torque.util.BasePeerImpl<TurbineUser>
{
    /** The class log. */
    private static Log log = LogFactory.getLog(BaseTurbineUserPeerImpl.class);

    /** Serial version */
    private static final long serialVersionUID = 1538675156908L;
     ...
     */
    public List<TurbineUser> doSelect(TurbineUser obj)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public TurbineUser doSelectSingleRecord(
                TurbineUser obj)
            throws TorqueException
    {
        List<TurbineUser> turbineUserList = doSelect(obj);
        TurbineUser turbineUser = null;
        if (turbineUserList.size() > 1)
        {
            throw new TooManyRowsException("Object " + obj 
                + " matched more than one record");
        }
        if (!turbineUserList.isEmpty())
        {
            turbineUser = turbineUserList.get(0);
        }
        return turbineUser;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(TurbineUser obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(TurbineUser obj, Connection con)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        Criteria selectCriteria 
                = new Criteria(TurbineUserPeer.DATABASE_NAME);
        correctBooleans(columnValues);

        selectCriteria.where(
                TurbineUserPeer.USER_ID,
                columnValues.remove(TurbineUserPeer.USER_ID).getValue());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(TurbineUser obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(TurbineUser obj, Connection con)
        throws TorqueException
    {
        ColumnValues columnValues = buildColumnValues(obj);
            ...
            throws TorqueException
    {
        ...
        for (TurbineUser object : objects)
        {
    ...
    {
        Criteria criteria = new Criteria(TurbineUserPeer.DATABASE_NAME);
        if (!obj.isNew())
        {
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        try
        {
            connection = Transaction.begin(TurbineUserPeer.DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineUser> retrieveByPKs(Collection<ObjectKey> pks)
        throws TorqueException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(TurbineUserPeer.DATABASE_NAME);
            List<TurbineUser> result = retrieveByPKs(pks, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineUser> retrieveByPKs(
