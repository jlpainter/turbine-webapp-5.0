...
{
    /** Serial version */
    private static final long serialVersionUID = 1538675156592L;
    ...
    public List<TurbineUserGroupRole> getTurbineUserGroupRoles(Criteria criteria) throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(org.apache.turbine.test.integrationtest.om.TurbineUserGroupRolePeer.USER_ID, getEntityId() );
    ...
    {
        return getTurbineUserGroupRolesJoinTurbineUser(criteria, null);
    }
        ...
        throws TorqueException
    {
        if (collTurbineUserGroupRoles == null)
        {
            ...
            {
                criteria.and(org.apache.turbine.test.integrationtest.om.TurbineUserGroupRolePeer.USER_ID, getEntityId() );
                collTurbineUserGroupRoles = org.apache.turbine.test.integrationtest.om.TurbineUserGroupRolePeer.doSelectJoinTurbineUser(criteria, connection);
            }
        }
        else
        {
    ...
    {
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.USER_ID))
        {
            return getEntityId();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.LOGIN_NAME))
        {
            return getEntityName();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.PASSWORD_VALUE))
        {
            return getPassword();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.FIRST_NAME))
        {
            return getFirstName();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.LAST_NAME))
        {
            return getLastName();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.EMAIL))
        {
            return getEmail();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.CONFIRM_VALUE))
        {
            return getConfirmed();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.MODIFIED_DATE))
        {
            return getModifiedDate();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.CREATED))
        {
            return getCreateDate();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.LAST_LOGIN))
        {
            return getLastLogin();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.TurbineUserPeer.OBJECTDATA))
        {
            return getObjectdata();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.USER_ID.getSqlExpression().equals(name))
        {
            return setByName("EntityId", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.LOGIN_NAME.getSqlExpression().equals(name))
        {
            return setByName("EntityName", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.PASSWORD_VALUE.getSqlExpression().equals(name))
        {
            return setByName("Password", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.FIRST_NAME.getSqlExpression().equals(name))
        {
            return setByName("FirstName", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.LAST_NAME.getSqlExpression().equals(name))
        {
            return setByName("LastName", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.EMAIL.getSqlExpression().equals(name))
        {
            return setByName("Email", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.CONFIRM_VALUE.getSqlExpression().equals(name))
        {
            return setByName("Confirmed", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.MODIFIED_DATE.getSqlExpression().equals(name))
        {
            return setByName("ModifiedDate", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.CREATED.getSqlExpression().equals(name))
        {
            return setByName("CreateDate", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.LAST_LOGIN.getSqlExpression().equals(name))
        {
            return setByName("LastLogin", value);
        }
        if (org.apache.turbine.test.integrationtest.om.TurbineUserPeer.OBJECTDATA.getSqlExpression().equals(name))
        {
    ...
    /** The Peer class */
    private static final org.apache.turbine.test.integrationtest.om.TurbineUserPeer peer
            = new org.apache.turbine.test.integrationtest.om.TurbineUserPeer();
     ...
     */
    public org.apache.turbine.test.integrationtest.om.TurbineUserPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return org.apache.turbine.test.integrationtest.om.TurbineUserPeer.getTableMap();
    }
    ...
    public boolean valueEquals(TurbineUser toCompare)
    {
        ...
        if (!ObjectUtils.equals(this.confirmed, toCompare.getConfirmed()))
        {
            return false;
        }
        if (!ObjectUtils.equals(this.modifiedDate, toCompare.getModifiedDate()))
        {
            return false;
        }
        if (!ObjectUtils.equals(this.createDate, toCompare.getCreateDate()))
        {
            return false;
        }
        if (!ObjectUtils.equals(this.lastLogin, toCompare.getLastLogin()))
        {
            return false;
        }
        if (!ObjectUtils.equals(this.objectdata, toCompare.getObjectdata()))
        {
            return false;
        }
        return true;
