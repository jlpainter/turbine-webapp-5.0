...
public abstract class BaseTurbineGroupPeerImpl
    extends org.apache.torque.util.BasePeerImpl<TurbineGroup>
{
    /** The class log. */
    private static Log log = LogFactory.getLog(BaseTurbineGroupPeerImpl.class);

    /** Serial version */
    private static final long serialVersionUID = 1538675156892L;
     ...
     */
    public List<TurbineGroup> doSelect(TurbineGroup obj)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public TurbineGroup doSelectSingleRecord(
                TurbineGroup obj)
            throws TorqueException
    {
        List<TurbineGroup> turbineGroupList = doSelect(obj);
        TurbineGroup turbineGroup = null;
        if (turbineGroupList.size() > 1)
        {
            throw new TooManyRowsException("Object " + obj 
                + " matched more than one record");
        }
        if (!turbineGroupList.isEmpty())
        {
            turbineGroup = turbineGroupList.get(0);
        }
        return turbineGroup;
    }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(TurbineGroup obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(TurbineGroup obj, Connection con)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        Criteria selectCriteria 
                = new Criteria(TurbineGroupPeer.DATABASE_NAME);
        correctBooleans(columnValues);

        selectCriteria.where(
                TurbineGroupPeer.GROUP_ID,
                columnValues.remove(TurbineGroupPeer.GROUP_ID).getValue());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(TurbineGroup obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(TurbineGroup obj, Connection con)
        throws TorqueException
    {
        ColumnValues columnValues = buildColumnValues(obj);
            ...
            throws TorqueException
    {
        ...
        for (TurbineGroup object : objects)
        {
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        try
        {
            connection = Transaction.begin(TurbineGroupPeer.DATABASE_NAME);
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineGroup> retrieveByPKs(Collection<ObjectKey> pks)
        throws TorqueException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(TurbineGroupPeer.DATABASE_NAME);
            List<TurbineGroup> result = retrieveByPKs(pks, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<TurbineGroup> retrieveByPKs(
