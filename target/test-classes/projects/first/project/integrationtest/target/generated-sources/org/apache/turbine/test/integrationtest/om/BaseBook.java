...
{
    /** Serial version */
    private static final long serialVersionUID = 1538675156421L;
        ...
        throws TorqueException
    {
        ...
        {
            aAuthor = org.apache.turbine.test.integrationtest.om.AuthorPeer.retrieveByPK(SimpleKey.keyFor(this.authId));
        }
        return aAuthor;
    }
        ...
        throws TorqueException
    {
        if (aAuthor == null && this.authId != 0)
        {
            aAuthor = org.apache.turbine.test.integrationtest.om.AuthorPeer.retrieveByPK(SimpleKey.keyFor(this.authId), connection);
        }
        return aAuthor;
    }
    ...
    {
        if (name.equals(org.apache.turbine.test.integrationtest.om.BookPeer.BOOK_ID))
        {
            return new Integer(getBookId());
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.BookPeer.AUTH_ID))
        {
            return new Integer(getAuthId());
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.BookPeer.TITLE))
        {
            return getTitle();
        }
        if (name.equals(org.apache.turbine.test.integrationtest.om.BookPeer.SUBJECT))
        {
            return getSubject();
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
        if (org.apache.turbine.test.integrationtest.om.BookPeer.BOOK_ID.getSqlExpression().equals(name))
        {
            return setByName("BookId", value);
        }
        if (org.apache.turbine.test.integrationtest.om.BookPeer.AUTH_ID.getSqlExpression().equals(name))
        {
            return setByName("AuthId", value);
        }
        if (org.apache.turbine.test.integrationtest.om.BookPeer.TITLE.getSqlExpression().equals(name))
        {
            return setByName("Title", value);
        }
        if (org.apache.turbine.test.integrationtest.om.BookPeer.SUBJECT.getSqlExpression().equals(name))
        {
    ...
    /** The Peer class */
    private static final org.apache.turbine.test.integrationtest.om.BookPeer peer
            = new org.apache.turbine.test.integrationtest.om.BookPeer();
     ...
     */
    public org.apache.turbine.test.integrationtest.om.BookPeer getPeer()
    {
        return peer;
    }
    ...
    {
        return org.apache.turbine.test.integrationtest.om.BookPeer.getTableMap();
    }
    ...
    public boolean valueEquals(Book toCompare)
    {
        ...
        if (!ObjectUtils.equals(this.subject, toCompare.getSubject()))
        {
            return false;
        }
        return true;
